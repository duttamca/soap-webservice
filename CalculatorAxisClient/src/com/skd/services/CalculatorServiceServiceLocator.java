...
public class CalculatorServiceServiceLocator extends org.apache.axis.client.Service implements com.skd.services.CalculatorServiceService {
    ...
    private java.lang.String CalculatorService_address = "http://localhost:8080/CalculatorAxis/services/CalculatorService";
    ...
    public com.skd.services.CalculatorService getCalculatorService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.skd.services.CalculatorServiceSoapBindingStub _stub = new com.skd.services.CalculatorServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.skd.services.CalculatorService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.skd.services.CalculatorServiceSoapBindingStub _stub = new com.skd.services.CalculatorServiceSoapBindingStub(new java.net.URL(CalculatorService_address), this);
                _stub.setPortName(getCalculatorServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://services.skd.com", "CalculatorServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://services.skd.com", "CalculatorService"));
        }
